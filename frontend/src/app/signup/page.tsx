...
const T = {
  en: {
    ...
    subtitle: "Start managing your farm with AI",
    fullName: "Full Name",
    email: "Email",
  ...
  fr: {
    ...
    subtitle: "G\u00e9rez votre exploitation avec l'IA",
    fullName: "Nom complet",
    email: "Email",
    password: "Mot de passe (min 6 car.)",
  ...
  wo: {
    title: "Sos sa compte",
    subtitle: "Saytu sa tool ak IA",
    fullName: "Sa tur",
    email: "Email",
    password: "Baatu jaam (6 min)",
    submit: "Sos compte",
